...
<style><%@include file="/WEB-INF/resourse/css/search.css"%></style>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav">
                    ...
                    <a href="/Final_Etour_Principal/Search" class="nav-item nav-link active">Search</a>
...
<div class="card">
    <div class="card-header">
      <div class="text-header" style="color: rgb(1, 1, 1);">Tours</div>
    </div>
    <div class="card-body">
      <form action="/Final_Etour_Principal/AfterSearch" method="post" >
        <div class="form-group">
          <label for="username">Date from:</label>
          <input required="" class="form-control" name="startDate" id="username" type="date" >
        </div>
        <div class="form-group">
          <label for="username">Date To:</label>
          <input required="" class="form-control" name="endDate" id="username" type="date" >
        </div>
        <div class="form-group">
          <label for="username">Maximum Price spend :</label>
          <input required="" class="form-control" name="cost" id="username" type="number">
        </div>
        <div class="form-group">
          <label for="username">Maximum Duration:</label>
          <input required="" class="form-control" name="duration" id="username" type="number">
        </div>
      ...
      <div class="row">
          <div class="col-sm-6 col-md-4 footer-navigation">
              ...
              <p class="company-name">piyushpatidar@gmail.com &copy; 2023</p>
          </div>
          <div class="col-sm-6 col-md-4 footer-contacts">
              <div><span class="fa fa-map-marker footer-contacts-icon"> </span>
                  <p><span class="new-line-span">Khargone MP </span></p>
              </div>
